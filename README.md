...
- 实验数据的图形分析:  [实验数据中的自变量和因变量](/chapters/实验前的准备/实验数据的图形分析/实验数据中的自变量和因变量.md) | [实验数据中的线性关系](/chapters/实验前的准备/实验数据的图形分析/实验数据中的线性关系.md) | [实验数据中的非线性关系](/chapters/实验前的准备/实验数据的图形分析/实验数据中的非线性关系.md)
